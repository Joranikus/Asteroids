...
AsteroidFactory::AsteroidFactory(Canvas& canvas,
    ...
    void AsteroidFactory::generate_wave(float dt, int wave_size, float asteroid_delay, float wave_delay) {
        // increment the timers
        time_since_last_asteroid += dt;

        // check if the wave is active and if all asteroids from the wave have been destroyed
